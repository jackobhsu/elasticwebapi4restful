...
public class test_queryitemcount {
...
//    	  
    	  ...
    	  Item item = qim.qetitem("elastic", "elastic06.idc1.fn", new String[]{"access_log-www-2014-03-18"}, "access_log", "item", "201403CM070000141" , "request_url_4", "request_url_3");
    	  
    	  //System.out.println(item.get_info());
    	  
    	  
//    	  Item item  = qim.qetitem("elastic", "elastic06.idc1.fn", new String[]{"access_log-www-2014-03-14"}, "access_log", "item", "201311CM080002285" , "request_url_4", "request_url_3");
//    	  System.out.println(" ======== ");
//    	  System.out.println(item.get_info());
//    	  
